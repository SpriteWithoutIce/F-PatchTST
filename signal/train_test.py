...
def main():
    df = read_csv('./total_im-patient-354.csv')  # 替换为你的CSV文件路径
    ...
    write_csv(train_df, '../data/train_total_im-patient.csv')
    write_csv(test_df, '../data/test_dataset_total_im-patient.csv')
    write_csv(new_df, '../data/test_label_total_im-patient.csv')
